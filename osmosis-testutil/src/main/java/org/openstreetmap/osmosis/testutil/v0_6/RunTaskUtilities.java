...
public final class RunTaskUtilities {
     ...
     */
    public static SinkEntityInspector run(
            MultiSinkRunnableSource multiSink, RunnableSource source1, RunnableSource source2) throws Exception {
     ...
     */
    public static SinkEntityInspector run(
            MultiSinkRunnableSource multiSink,
            RunnableSource source1,
            RunnableSource source2,
     ...
     * @throws Exception if something goes wrong.
     */
    public static SinkChangeInspector run(
            MultiSinkRunnableChangeSource multiSink, RunnableSource source1, RunnableSource source2) throws Exception {
        return run(multiSink, source1, source2, null);
    }
     ...
     */
    public static SinkChangeInspector run(
            MultiSinkRunnableChangeSource multiSink,
            RunnableSource source1,
            RunnableSource source2,
            Thread.UncaughtExceptionHandler exceptionHandler)
            throws Exception {
    ...
    private static void runCore(
            Runnable multiSink, Runnable source1, Runnable source2, Thread.UncaughtExceptionHandler exceptionHandler)
