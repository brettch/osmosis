...
public class ReplicationLagReaderFactory extends WorkingTaskManagerFactory {
    ...
    protected TaskManager createTaskManagerImpl(TaskConfiguration taskConfig) {
        ...
        humanReadableFlag = getBooleanArgument(taskConfig, ARG_HUMAN_READABLE, DEFAULT_HUMAN_READABLE);

        return new RunnableTaskManager(
                taskConfig.getId(),
                new ReplicationLagReader(this.getWorkingDirectory(taskConfig), humanReadableFlag),
