...
public class PostgreSqlDatasetContext implements DatasetContext {
    ...
    public ReleasableIterator<EntityContainer> iterateBoundingBox(
        ...
        try {
            ...
            preparedStatement =
                    dbCtx.prepareStatement("INSERT INTO box_node_list SELECT id FROM nodes WHERE (geom && ?)");
            prmIndex = 1;
            ...
            if (capabilityChecker.isWayLinestringSupported()) {
                ...
                preparedStatement = dbCtx.prepareStatement(
                        "INSERT INTO box_way_list " + "SELECT id FROM ways w where w.linestring && ?");
                prmIndex = 1;
                preparedStatement.setObject(prmIndex++, new PGgeometry(bboxPolygon));
                ...
                preparedStatement = dbCtx.prepareStatement("INSERT INTO box_way_list "
                        + "SELECT way_id FROM ("
            ...
            preparedStatement = dbCtx.prepareStatement("INSERT INTO box_relation_list ("
            ...
            if (completeWays) {
                ...
                preparedStatement = dbCtx.prepareStatement("INSERT INTO box_node_list "
            ...
            resultSets.add(new UpcastIterator<EntityContainer, BoundContainer>(
                    new BoundContainerIterator(new ReleasableAdaptorForIterator<Bound>(bounds.iterator()))));
            resultSets.add(new UpcastIterator<EntityContainer, NodeContainer>(
                    new NodeContainerIterator(new NodeReader(dbCtx, "box_node_list"))));
            resultSets.add(new UpcastIterator<EntityContainer, WayContainer>(
                    new WayContainerIterator(new WayReader(dbCtx, "box_way_list"))));
            resultSets.add(new UpcastIterator<EntityContainer, RelationContainer>(
