...
public abstract class EntityDao<T extends Entity> extends BaseDao {
    ...
    public boolean exists(long entityId) {
        ...
        try {
            ...
            throw new OsmosisRuntimeException(
                    "Count query failed for " + entityMapper.getEntityName() + " " + entityId + ".", e);
        }
    }
    ...
    public T getEntity(long entityId) {
        ...
        try {
            ...
            throw new OsmosisRuntimeException(
                    "Query failed for " + entityMapper.getEntityName() + " " + entityId + ".", e);
        }
    }
    ...
    public void addEntity(T entity) {
        ...
        try {
            ...
            throw new OsmosisRuntimeException(
                    "Insert failed for " + entityMapper.getEntityName() + " " + entity.getId() + ".", e);
        }
    ...
    public void modifyEntity(T entity) {
        ...
        try {
            ...
            throw new OsmosisRuntimeException(
                    "Update failed for " + entityMapper.getEntityName() + " " + entity.getId() + ".", e);
        }
    ...
    public void removeEntity(long entityId) {
        ...
        try {
            ...
            throw new OsmosisRuntimeException(
                    "Delete failed for " + entityMapper.getEntityName() + " " + entityId + ".", e);
        }
