...
public class RelationReader extends EntityReader<Relation> {
    ...
    public RelationReader(DatabaseContext dbCtx) {
        ...
        relationMemberReader = new PeekableIterator<DbOrderedFeature<RelationMember>>(new EntityFeatureTableReader<
                RelationMember, DbOrderedFeature<RelationMember>>(dbCtx, new RelationMemberMapper()));
    }
    ...
    public RelationReader(DatabaseContext dbCtx, String constraintTable) {
        ...
        relationMemberReader = new PeekableIterator<DbOrderedFeature<RelationMember>>(new EntityFeatureTableReader<
                RelationMember, DbOrderedFeature<RelationMember>>(dbCtx, new RelationMemberMapper(), constraintTable));
    }
