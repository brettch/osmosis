...
public class OsmosisReaderTest extends AbstractDataTest {
    ...
    public void testWriteAndRead() throws IOException {
        ...
        Osmosis.run(
                new String[] {"-q", "--read-xml-0.6", inputXmlFile.getPath(), "--write-pbf-0.6", pbfFile.getPath()});

        // Read the PBF using the PBF2 reader and write to XML.
        Osmosis.run(
                new String[] {"-q", "--read-pbf-fast-0.6", pbfFile.getPath(), "--write-xml-0.6", outputXmlFile.getPath()
                });
