        ...
        try {
            ...
            while ((changeContainer0 != null || postbox0.hasNext())
                ...
                comparisonResult = comparator.compare(
                        changeContainer0.getEntityContainer(), changeContainer1.getEntityContainer());
                ...
                if (comparisonResult < 0) {
                    ...
                    if (conflictResolutionMethod.equals(ConflictResolutionMethod.Timestamp)) {
                        ...
                        timestampComparisonResult = changeContainer0
                                .getEntityContainer()
                                .getEntity()
                                .getTimestamp()
                                .compareTo(changeContainer1
                                        .getEntityContainer()
                                        .getEntity()
                                        .getTimestamp());
                        ...
                        int version0 = changeContainer0
                                .getEntityContainer()
                                .getEntity()
                                .getVersion();
                        int version1 = changeContainer1
                                .getEntityContainer()
                                .getEntity()
                                .getVersion();
