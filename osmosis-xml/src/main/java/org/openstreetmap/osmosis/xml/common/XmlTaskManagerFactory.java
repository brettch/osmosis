...
public abstract class XmlTaskManagerFactory extends TaskManagerFactory {
    ...
    protected CompressionMethod getCompressionMethodArgument(TaskConfiguration taskConfig, String fileName) {
        ...
        String rawValue =
                getStringArgument(taskConfig, ARG_COMPRESSION_METHOD, "auto").toLowerCase();
        ...
        if ("none".equals(rawValue)) {
            ...
            throw new OsmosisRuntimeException("Argument " + ARG_COMPRESSION_METHOD + " for task " + taskConfig.getId()
