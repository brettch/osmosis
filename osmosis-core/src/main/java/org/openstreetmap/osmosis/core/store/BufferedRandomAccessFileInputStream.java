...
public class BufferedRandomAccessFileInputStream extends InputStream {
    ...
    public BufferedRandomAccessFileInputStream(
            File file, int bufferCount, int initialBufferSize, int maxBufferSize, float bufferIncreaseFactor)
            throws FileNotFoundException {
    ...
    private static class BufferedReader {
         ...
         */
        BufferedReader(
                RandomAccessFile randomFile, int initialBufferSize, int maxBufferSize, float bufferIncreaseFactor) {
